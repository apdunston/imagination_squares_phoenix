...
export function init(document) {
  ...
  global.view = new View(canvas, 10);
  ...
  function setCanvasSize() {
    ...
    ctx.canvas.width  = window.innerWidth - document.querySelector('canvas').getBoundingClientRect().left-20;
    ctx.canvas.height = window.innerHeight - document.querySelector('canvas').getBoundingClientRect().top-20;  
  }
